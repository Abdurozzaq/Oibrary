  ...
  <v-app id="inspire">
      ...
      <v-list>
        ...
        >
          ...
          <v-list-item
            ...
            href="/home/menu/list"
          >
            <v-list-item-title>Kembalikan Buku</v-list-item-title>
            <v-list-item-icon>
    ...
    >
      ...
      <v-toolbar-title
        ...
        class="ml-0 pl-4"
      >
        <span class="hidden-sm-and-down">SD TECHSTUFF <code class="blue lighten-5 blue--text text--darken-3">Member</code></span>
      </v-toolbar-title>
      <v-spacer></v-spacer>
      <v-menu
        v-model="menu"
